...
### Global D855 16gb, Updated: 02/07/2016          ###
######################################################
...
# TARGET_KERNEL_CONFIG := cyanogen_d855_lowmem_defconfig
...
### Updated: 02/07/2016                           ###
#####################################################
#TARGET_KERNEL_CONFIG := cyanogenmod_d851_lowmem_defconfig
...
MR_INIT_DEVICES := device/lge/d855_lowmem/multirom/mr_init_devices.c
MR_RD_ADDR := 0x2200000
MR_DPI := xhdpi
MR_DPI_MUL := 1.5
MR_FSTAB := device/lge/d855_lowmem/multirom/twrp.fstab
...
MR_DEVICE_HOOKS := device/lge/d855_lowmem/multirom/mr_hooks.c
